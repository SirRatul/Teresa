                                            ...
                                            <div className="col-12 col-lg-8">
                                                ...
                                                <div className="row">
                                                    <div className="col-5 col-sm-5">
                                                        ...
                                                        <p className='form-header-medicine'>(According to the uploaded prescription)</p>
                                                    </div>
                                                    <div className="col-3 col-sm-3">
                                                        <div className="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" id="unit" name="exampleRadios" className="custom-control-input" value="Unit"/>
                                                            <label className="custom-control-label unit" htmlFor="unit">Unit</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-3 col-sm-3">
                                                        <div className="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" id="day" name="exampleRadios" className="custom-control-input" value="Day"/>
                                                ...
                                                {inputList.map((x, i) => {
                                                    return (
                                                        <div className="row mb-4" key={i}>
                                                            ...
                                                            <div className="col-3 col-sm-3">
                                                                <input type="text" className="form-control rounded-pill form-input-background" name="unit" value={x.unit} onChange={e => handleInputChange(e, i)}/>
                                                            </div>
                                                            <div className="col-3 col-sm-3">
                                                                <input type="text" className="form-control rounded-pill form-input-background" name="day" value={x.day} onChange={e => handleInputChange(e, i)}/>
                                                            </div>
