...
const Menu = () => {
    ...
    return  <Navbar className="my-nav" expand="lg" sticky="top">
        ...
        <Navbar.Brand href="/">
            <img src={Logo} width="100" height="70" className="d-inline-block align-top ml-5" alt="Logo"/>
        </Navbar.Brand>
            ...
            <ul className="navbar-nav ml-auto">
                ...
                <NavDropdown 
                    ...
                    title={
                        ...
                        <NavDropdown.Item className="justify-content-lg-center text-white" href="/upload-prescription" style={{marginLeft: '0.8rem'}}>
                            Upload Prescription
                        </NavDropdown.Item>
                ...
                </Nav.Item>
                {
                    ...
                    <Nav.Item>
                        <Nav.Link className="text-light">
                            ...
                            <img src={LogoutButton} className="ml-n2 ml-lg-0 mt-0 mt-lg-n2 login-button" alt="Logout Button" onClick={logoutHandler}/>
                        </Nav.Link>
                    </Nav.Item>
                    :
                    <Nav.Item>
